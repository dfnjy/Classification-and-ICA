...
if __name__ == '__main__':
    ...
    parser.add_argument('-content_file', default='cora.content', help='The path to the content file.')
    parser.add_argument('-cites_file', default='cora.cites', help='The path to the cites file.')  
    ...
    parser.add_argument('-directed', default=True, action='store_true', help='Use direction of the edges for aggregates.')
    ...
    for t in range(args.num_trials):
        for b in budget:
            ...
            # True labels
            y_true=[graph.node_list[i].label for i in test]
